    ...
    public static void main(String[] Args) {
        ...
        try {
           ...
           // acceptPlayer(serverSocket,playerSockets[1],printWriters[1],bufferedReaders[1]);
            ...
            ArrayList<HashSet<Integer>> moves=new ArrayList<HashSet<Integer>>();
            ...
            while (true){
               ...
               if (moves.get(turn^1).contains(Integer.parseInt(moveValue))){
                   try {
               ...
               moves.get(turn).add(Integer.parseInt(moveValue));
